...
static const float3 COLOR1 = {0.299f, 0.587f, 0.114f};
static const float3 COLOR2 = {0.984f, 0.949f, 0.639f};
static const float3 COLOR3 = {0.909f, 0.396f, 0.702f};
static const float3 COLOR4 = {0.035f, 0.286f, 0.914f};
