...
public class MosaicFrameProcessor {
    ...
    public void clear() {
    	Log.d(TAG,"###YUHUAN###clear#mIsMosaicMemoryAllocated=" + mIsMosaicMemoryAllocated);
    ...
    private void setupMosaicer(int previewWidth, int previewHeight, int bufSize) {
        Log.v(TAG, "###YUHUAN###setupMosaicer#previewWidth=" + previewWidth + ",previewHeight=" + previewHeight + ",bufSize=" + bufSize);
