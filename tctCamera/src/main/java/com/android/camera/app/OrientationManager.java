...
public class OrientationManager {
    ...
    private OrientationManager(Activity activity) {
        mActivity = activity;
        mOrientationListener = new MyOrientationEventListener(activity);
    }
    
    private static OrientationManager mOrientationManagerInstance;
    
    public static OrientationManager getInstance(Activity activity){
    	mOrientationManagerInstance=new OrientationManager(activity);
    	return mOrientationManagerInstance;
    }
