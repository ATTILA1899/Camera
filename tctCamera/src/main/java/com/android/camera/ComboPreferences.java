...
public class ComboPreferences implements
    ...
    private static boolean isGlobal(String key) {
        return key.equals(CameraSettings.KEY_VIDEO_TIME_LAPSE_FRAME_INTERVAL)
                ...
                || key.equals(CameraSettings.KEY_SOUND)
                || key.equals(CameraSettings.KEY_CAMERA_SAVEPATH)
                //|| key.equals(CameraSettings.KEY_CAMERA_ARCSOFT_NIGHT)
                || key.equals(CameraSettings.KEY_CAMERA_GRID)
                || key.equals(CameraSettings.KEY_GPS_TAG);
//                || key.equals(CameraSettings.KEY_PICTURE_RATIO);
    }
