...
public class VideoUI implements PieRenderer.PieListener,
    ...
    private static final String TAG = "YUHUAN_VideoUI";
    ...
    private TextView mRecordingProgressView;
    ...
    //Add by zhiming.yu for PR913890
    ...
    public void setPreviewSize(int width, int height) {
    	Log.d(TAG,"###YUHUAN###setPreviewSize#width=" + width + "height=" + height);
        if (width == 0 || height == 0) {
        ...
        Log.d(TAG,"###YUHUAN###setPreviewSize#ratio=" + ratio);
        Log.d(TAG,"###YUHUAN###setPreviewSize#mAspectRatio=" + mAspectRatio);
    ...
    private void initializeMiscControls() {
        ...
        mRecordingProgressView = (TextView) mRootView.findViewById(R.id.recording_progress);
    ...
    public void showTimeLapseUI(boolean enable) {
    	Log.d(TAG,"###YUHUAN###showTimeLapseUI#enable=" + enable);
...
//        mController.onSingleTapUp(view, x, y);
    ...
    public void showRecordingTimeUI(boolean show) {
        mRecordingTimeView.setVisibility(show ? View.VISIBLE : View.GONE);
    }

    public void showRecordingProgress(boolean show) {
        mRecordingProgressView.setVisibility(show ? View.VISIBLE : View.GONE);
    }

    public void setRecordingTimeImage(boolean recording) {
        Drawable leftDrawable = mActivity.getResources().getDrawable(recording ?
            R.drawable.ic_recording_indicator : R.drawable.ic_recording_pause);
        mRecordingTimeView.setCompoundDrawablesWithIntrinsicBounds(leftDrawable, null, null, null);
    }
    ...
    public void showRecordingUI(boolean recording) {
        ...
        if (recording) {
            setRecordingTimeImage(true);
            mRecordingTimeView.setText("");
            mRecordingTimeView.setVisibility(View.VISIBLE);
            mBackButtonManager.show();//Add by zhiming.yu for PR913890
        } else {
    ...
    public void setRecordingProgress(int progress) {
        mRecordingProgressView.setText(progress+"%");
    }
    ...
    public void onSurfaceTextureUpdated(SurfaceTexture surface) {
        ...
        //[BUGFIX]-Del by TCTNB,xianbin.tang, 2014-08-27,PR766200 Begin
        /*if (mPreviewCover.getVisibility() != View.GONE) {
            mPreviewCover.setVisibility(View.GONE);
        }*/
        //[BUGFIX]-Del by TCTNB,xianbin.tang, 2014-08-27,PR766200 End
    }
