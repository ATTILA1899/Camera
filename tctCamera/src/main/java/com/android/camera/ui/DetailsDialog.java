...
//[BUGFIX]-Add by TCTNB,shidong.hou, 2014-08-21,PR764202 Begin
import android.util.Log;
//[BUGFIX]-Add by TCTNB,shidong.hou, 2014-08-21,PR764202 End
/**
...
public class DetailsDialog {
    ...
    //[BUGFIX]-Add by TCTNB,shidong.hou, 2014-08-21,PR764202 Begin
    private static final String TAG = "YUHUAN_DetailsDialog";
    //[BUGFIX]-Add by TCTNB,shidong.hou, 2014-08-21,PR764202 End
    /**
     ...
     */
    public static Dialog create(Context context, MediaDetails mediaDetails,final DialogRunnable r1) {
    	View view = LayoutInflater.from(context).inflate(
                R.layout.details_list, null, false);
    	ListView detailsList = (ListView)view.findViewById(R.id.detail_listview);
        ...
        return builder.setTitle(R.string.details).setView(view)
            ...
            for (Entry<Integer, Object> detail : details) {
                ...
                switch (detail.getKey()) {
                    ...
                    default: {
                        ...
                        if (valueObj == null) {
                            //[BUGFIX]-Mod by TCTNB,shidong.hou, 2014-08-21,PR764202 Begin
                            /*
                            fail("%s's value is Null",
                                    getDetailsName(context,
                                            detail.getKey()));
                            */
                            Log.e(TAG, getDetailsName(context,
                                    detail.getKey()) + "'s value is Null");
                            continue;
                            //[BUGFIX]-Mod by TCTNB,shidong.hou, 2014-08-21,PR764202 End
                        }
